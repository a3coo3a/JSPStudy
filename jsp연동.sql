...
begin
    ...
    loop
        ...
        insert into bbs(bno, writer, title, content, id) values( bbs_seq.nextval, 'test02', 'test02', 'test02', '개똥이');
        insert into bbs(bno, writer, title, content, id) values( bbs_seq.nextval, 'test3', 'test3', 'test3', '똥똥이');
